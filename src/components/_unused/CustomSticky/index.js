...
if (typeof CSS !== "undefined" && CSS.supports) {
  if (CSS.supports("position", "sticky")) stickyProp = "fixed";else if (CSS.supports("position", "-webkit-sticky")) stickyProp = "-webkit-sticky";
...
function (_React$Component) {
  ...
  function StickyBox(props) {
    ...
    _this.handleParentNodeResize = function () {
      ...
      _this.parentHeight = _this.node.getBoundingClientRect().height - (parentPaddingTop + parentPaddingBottom);
      
      //console.log('getBoundingClientRect().height', _this.node.getBoundingClientRect().height)
      //console.log('par-getBoundingClientRect().height', parentNode.getBoundingClientRect().height)
    ...
    _this.handleScroll = function () {
      ...
      if (scrollDelta > 0) {
        ...
        if (_this.mode === "stickyBottom") {
         /* console.log('stbot');
          console.log('_this.nodeHeight', _this.nodeHeight);
      console.log('offsetTop', offsetTop);
      console.log('_this.viewPortHeight', _this.viewPortHeight);
      console.log('_this.naturalTop',_this.naturalTop);
      console.log('offsetBottom', offsetBottom);
      console.log('_this.scrollPaneOffset', _this.scrollPaneOffset);
      console.log('_this.parentHeight', _this.parentHeight);
