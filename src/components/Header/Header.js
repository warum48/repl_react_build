                    ...
                    <Col>
                      ...
                      <div className="box_rel">
                        ...
                        <a className="logo_sp"  href={props.onmain? "#product" : "index.html#product"} rel="noreferrer noopener">
                            <span>
                              <object className="img-fluid" type="image/svg+xml" data="./assets/img/logo_sp.svg" name="logo_sp"></object>
                            </span>
                        </a> 
                      </LinkGA> 
                      <LinkGA action='Travlinet_logo'>
                        ...
                        <a className="logo_cos" href="https://www.cosmo.ru/" target="_blank"  rel="noreferrer noopener">
                            <span>
                              <object className="img-fluid" type="image/svg+xml" data="./assets/img/logo_cos.svg" name="logo_cos"></object>
                            </span>
                          </a>
                        </LinkGA>  
